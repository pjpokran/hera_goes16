...
#
fig = plt.figure(figsize=(wi_image_size_x/4,wi_image_size_y/4),dpi=80.)
fig2 = plt.figure(figsize=(mw_image_size_x/4,mw_image_size_y/4),dpi=160.)
fig3 = plt.figure(figsize=(conus_image_size_x/4,conus_image_size_y/4),dpi=160.)
fig4 = plt.figure(figsize=(ne_image_size_x/4,ne_image_size_y/4),dpi=160.)
#fig2 = plt.figure(figsize=(image_columns/200.,image_rows/200.))
fig9 = plt.figure(figsize=(image_columns/320.,image_rows/320.))
...
filename1="/whirlwind/goes16/test/MAP_"+dt+"_wi.jpg"
filename2="/whirlwind/goes16/test/MAP_"+dt+"_mw.jpg"
filename3="/whirlwind/goes16/test/MAP_"+dt+"_conus.jpg"
filename4="/whirlwind/goes16/test/MAP_"+dt+"_ne.jpg"
filename9="/whirlwind/goes16/test/MAP_"+dt+"_full.jpg"
