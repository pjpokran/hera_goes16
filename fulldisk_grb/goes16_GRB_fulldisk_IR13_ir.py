...
import glob
# NAMER
file_list = glob.glob('/whirlwind/goes16/ir13/namer/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 images
thefile = open('/whirlwind/goes16/ir13/namer_24_temp.list', 'w')
...
os.rename('/whirlwind/goes16/ir13/namer_24_temp.list','/whirlwind/goes16/ir13/goes16_namer_loop.list')

# 12h // 60 images
thefile = open('/whirlwind/goes16/ir13/namer_60_temp.list', 'w')
...
os.rename('/whirlwind/goes16/ir13/namer_60_temp.list','/whirlwind/goes16/ir13/goes16_namer_loop_60.list')

# 1 week // every 3rd image (337 by 3)
thefile = open('/whirlwind/goes16/ir13/namer_week_temp.list', 'w')
...
os.rename('/whirlwind/goes16/ir13/namer_week_temp.list','/whirlwind/goes16/ir13/goes16_namer_loop_week.list')
...
# FULLDISK
file_list = glob.glob('/whirlwind/goes16/ir13/fulldisk/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 images
thefile = open('/whirlwind/goes16/ir13/fulldisk_24_temp.list', 'w')
thelist = file_list[-24:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/ir13/fulldisk_24_temp.list','/whirlwind/goes16/ir13/goes16_fulldisk_loop.list')

# 12h // 60 images
thefile = open('/whirlwind/goes16/ir13/fulldisk_60_temp.list', 'w')
thelist = file_list[-60:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/ir13/fulldisk_60_temp.list','/whirlwind/goes16/ir13/goes16_fulldisk_loop_60.list')
