...
import glob
# NAMER
file_list = glob.glob('/whirlwind/goes16/wv/namer/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 images
thefile = open('/whirlwind/goes16/wv/namer_24_temp.list', 'w')
...
thefile.close
os.rename('/whirlwind/goes16/wv/namer_24_temp.list','/whirlwind/goes16/wv/goes16_namer_loop.list')

# 12h // 60 images
thefile = open('/whirlwind/goes16/wv/namer_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/wv/namer_60_temp.list','/whirlwind/goes16/wv/goes16_namer_loop_60.list')
...
# FULLDISK
file_list = glob.glob('/whirlwind/goes16/wv/fulldisk/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 images
thefile = open('/whirlwind/goes16/wv/fulldisk_24_temp.list', 'w')
thelist = file_list[-24:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/wv/fulldisk_24_temp.list','/whirlwind/goes16/wv/goes16_fulldisk_loop.list')

# 12h // 60 images
thefile = open('/whirlwind/goes16/wv/fulldisk_60_temp.list', 'w')
thelist = file_list[-60:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/wv/fulldisk_60_temp.list','/whirlwind/goes16/wv/goes16_fulldisk_loop_60.list')
