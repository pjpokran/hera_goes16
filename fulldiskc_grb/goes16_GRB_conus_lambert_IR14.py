...
# ABI 13
#f = netCDF4.Dataset("/home/ldm/data/grb-test/OR_ABI-L1b-RadC-M3C13_G16_s20172991812207_e20172991814592_c20172991815029.nc")
# ABI 14
#f = netCDF4.Dataset("/home/ldm/data/grb-test/OR_ABI-L1b-RadF-M3C14_G16_s20172991845398_e20172991856165_c20172991856231.nc")
f = netCDF4.Dataset("/home/ldm/data/grb/conus/14/OR_ABI-L1b-RadC-M3C14_G16_s20173102232190_e20173102234563_c20173102235009.nc")
...
print("radiance values from y,x = 0-10, 0-10 (far northwest corner) ", f.variables['Rad'][3000:3010,3000:3010])
...
print("BT values from y,x = 3000-3010, 3000-3010 (far northwest corner) ", data_var[3000:3010,3000:3010])
...
#fig9 = plt.figure(figsize=(13.128205128,13.128205128))
#fig9 = plt.figure(figsize=(23.179487179,23.179487179))
fig9 = plt.figure(figsize=(15.150909296,15.150909296))
...
#ax9 = fig9.add_subplot(1, 1, 1, projection='lambert')

ax9.set_extent((-94.0,-85.0,41.0,49.0))
...
#im = ax.imshow(a[namer_image_crop_top:namer_image_crop_bottom,namer_image_crop_left:namer_image_crop_right], extent=(xa[namer_image_crop_left],xa[namer_image_crop_right],ya[namer_image_crop_bottom],ya[namer_image_crop_top]), origin='upper',cmap=my_cmap2, vmin=0., vmax=1.)
...
#im = ax2.imshow(a[:], extent=(xa[0],xa[-1],ya[-1],ya[0]), origin='upper', cmap=my_cmap2)
...
filename9="/whirlwind/goes16/test/grbtest_ABI14_lambert_1.jpg"
