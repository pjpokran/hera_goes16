...
# ABI 2
f = netCDF4.Dataset("/home/ldm/data/grb-test/OR_ABI-L1b-RadC-M3C02_G16_s20173001947209_e20173001949582_c20173001950018.nc")
# ABI 13
...
im = ax9.imshow(a[:], extent=(xa[0],xa[-1],ya[-1],ya[0]), origin='upper', cmap=my_cmap2, vmin=0., vmax=1., transform=proj2)
...
filename9="/whirlwind/goes16/test/grbtest_lambert_1.jpg"
