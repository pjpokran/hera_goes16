...
filename1="/whirlwind/goes16/irc/namer/"+ctime_file_string+"_namer.jpg"
filename2="/whirlwind/goes16/irc/fulldisk/"+ctime_file_string+"_fulldisk.jpg"
#filename3="/whirlwind/goes16/vis_sqrt/conus/"+dt+"_conus.jpg"
filename9="/whirlwind/goes16/irc/fulldisk_full/"+ctime_file_string+"_fulldisk_full.jpg"
...
import glob
# NAMER
file_list = glob.glob('/whirlwind/goes16/irc/namer/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 images
thefile = open('/whirlwind/goes16/irc/namer_24_temp.list', 'w')
...
thefile.close
os.rename('/whirlwind/goes16/irc/namer_24_temp.list','/whirlwind/goes16/irc/goes16_namer_loop.list')

# 12h // 60 images
thefile = open('/whirlwind/goes16/irc/namer_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/irc/namer_60_temp.list','/whirlwind/goes16/irc/goes16_namer_loop_60.list')

# 1 week // every 3rd image (337 by 3)
thefile = open('/whirlwind/goes16/irc/namer_week_temp.list', 'w')
...
os.rename('/whirlwind/goes16/irc/namer_week_temp.list','/whirlwind/goes16/irc/goes16_namer_loop_week.list')


os.remove("/whirlwind/goes16/irc/namer/latest_namer_24.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_23.jpg", "/whirlwind/goes16/irc/namer/latest_namer_24.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_22.jpg", "/whirlwind/goes16/irc/namer/latest_namer_23.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_21.jpg", "/whirlwind/goes16/irc/namer/latest_namer_22.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_20.jpg", "/whirlwind/goes16/irc/namer/latest_namer_21.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_19.jpg", "/whirlwind/goes16/irc/namer/latest_namer_20.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_18.jpg", "/whirlwind/goes16/irc/namer/latest_namer_19.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_17.jpg", "/whirlwind/goes16/irc/namer/latest_namer_18.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_16.jpg", "/whirlwind/goes16/irc/namer/latest_namer_17.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_15.jpg", "/whirlwind/goes16/irc/namer/latest_namer_16.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_14.jpg", "/whirlwind/goes16/irc/namer/latest_namer_15.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_13.jpg", "/whirlwind/goes16/irc/namer/latest_namer_14.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_12.jpg", "/whirlwind/goes16/irc/namer/latest_namer_13.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_11.jpg", "/whirlwind/goes16/irc/namer/latest_namer_12.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_10.jpg", "/whirlwind/goes16/irc/namer/latest_namer_11.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_9.jpg", "/whirlwind/goes16/irc/namer/latest_namer_10.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_8.jpg", "/whirlwind/goes16/irc/namer/latest_namer_9.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_7.jpg", "/whirlwind/goes16/irc/namer/latest_namer_8.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_6.jpg", "/whirlwind/goes16/irc/namer/latest_namer_7.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_5.jpg", "/whirlwind/goes16/irc/namer/latest_namer_6.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_4.jpg", "/whirlwind/goes16/irc/namer/latest_namer_5.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_3.jpg", "/whirlwind/goes16/irc/namer/latest_namer_4.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_2.jpg", "/whirlwind/goes16/irc/namer/latest_namer_3.jpg")
os.rename("/whirlwind/goes16/irc/namer/latest_namer_1.jpg", "/whirlwind/goes16/irc/namer/latest_namer_2.jpg")

shutil.copy(filename1, "/whirlwind/goes16/irc/namer/latest_namer_1.jpg")

# FULLDISK
file_list = glob.glob('/whirlwind/goes16/irc/fulldisk/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 images
thefile = open('/whirlwind/goes16/irc/fulldisk_24_temp.list', 'w')
thelist = file_list[-24:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/irc/fulldisk_24_temp.list','/whirlwind/goes16/irc/goes16_fulldisk_loop.list')

# 12h // 60 images
thefile = open('/whirlwind/goes16/irc/fulldisk_60_temp.list', 'w')
thelist = file_list[-60:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/irc/fulldisk_60_temp.list','/whirlwind/goes16/irc/goes16_fulldisk_loop_60.list')



os.remove("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_24.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_23.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_24.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_22.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_23.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_21.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_22.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_20.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_21.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_19.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_20.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_18.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_19.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_17.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_18.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_16.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_17.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_15.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_16.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_14.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_15.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_13.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_14.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_12.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_13.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_11.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_12.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_10.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_11.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_9.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_10.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_8.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_9.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_7.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_8.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_6.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_7.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_5.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_6.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_4.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_5.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_3.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_4.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_2.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_3.jpg")
os.rename("/whirlwind/goes16/irc/fulldisk/latest_fulldisk_1.jpg", "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_2.jpg")

shutil.copy(filename2, "/whirlwind/goes16/irc/fulldisk/latest_fulldisk_1.jpg")
shutil.copy(filename9, "/whirlwind/goes16/irc/fulldisk_full/latest_fulldisk_full_1.jpg")
