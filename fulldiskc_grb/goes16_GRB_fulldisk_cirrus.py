...
namer_image_crop_left=900
namer_image_crop_right=-900
#
...
im2 = ax2.imshow(a[:], extent=(xa[0],xa[-1],ya[-1],ya[0]), origin='upper', cmap='Greys_r', vmin=0., vmax=1.)
...
im9 = ax9.imshow(a[:], extent=(xa[0],xa[-1],ya[-1],ya[0]), origin='upper', cmap='Greys_r', vmin=0., vmax=1.)
...
cbar2.ax.tick_params(labelsize=font_size, labelcolor='yellow')
...
time_string = 'GOES-16 Band 13 Clean LW IR Window valid %s '%ctime_string
print(time_string)
...
filename1="/whirlwind/goes16/test/"+ctime_file_string+"_namer.jpg"
filename2="/whirlwind/goes16/test/"+ctime_file_string+"_fulldisk.jpg"
#filename3="/whirlwind/goes16/vis_sqrt/conus/"+dt+"_conus.jpg"
filename9="/whirlwind/goes16/test/"+ctime_file_string+"_fulldisk_full.jpg"
