...
amazon_image_crop_top=2500
amazon_image_crop_bottom=-1700
amazon_image_crop_left=2800
amazon_image_crop_right=-1300
#
amazon_image_size_y=(image_rows+amazon_image_crop_bottom-amazon_image_crop_top)
amazon_image_size_x=(image_columns+amazon_image_crop_right-amazon_image_crop_left)
#
print("amazon image size")
print(amazon_image_size_x, amazon_image_size_y)
#
#wi_image_size_x=float(wi_image_size_x)/120.
#wi_image_size_y=float(wi_image_size_y)/120.
#namer_image_size_x=float(namer_image_size_x)/80.
#namer_image_size_y=float(namer_image_size_y)/80.
amazon_image_size_x=15.1
amazon_image_size_y=12.6
...
#fig16 = plt.figure(figsize=(image_columns/78.,image_rows/78.))
fig16 = plt.figure(figsize=(13.24,12.24))
...
im16 = ax16.imshow(a[amazon_image_crop_top:amazon_image_crop_bottom,amazon_image_crop_left:amazon_image_crop_right], extent=(xa[amazon_image_crop_left],xa[amazon_image_crop_right],ya[amazon_image_crop_bottom],ya[amazon_image_crop_top]), origin='upper',cmap=my_cmap, vmin=162., vmax=330.)
...
ax16.coastlines(resolution='50m', color='green', linewidth=2)
...
ax16.add_feature(cfeat.BORDERS, linewidth=1, edgecolor='orange')
...
cbar16 = fig16.colorbar(im16, cax=cbaxes16, orientation='horizontal')
font_size = 14
#cbar1.set_label('Brightness Temperature (K)',size=18)
cbar16.ax.tick_params(labelsize=font_size, labelcolor='yellow')
...
text16 = ax16.text(0.005, 0.88, time_string,
    horizontalalignment='left', transform = ax16.transAxes,
    color='yellow', fontsize='small', weight='bold')
#
text16.set_path_effects(outline_effect)


#filename1="/whirlwind/goes16/swir/namer/"+ctime_file_string+"_namer.jpg"
#filename0="/whirlwind/goes16/swir/namer/latest_namer_1s.jpg"
#filename2="/whirlwind/goes16/swir/fulldisk/"+ctime_file_string+"_fulldisk.jpg"
#filename20="/whirlwind/goes16/swir/fulldisk/latest_fulldisk_1s.jpg"
##filename3="/whirlwind/goes16/vis_sqrt/conus/"+dt+"_conus.jpg"
#filename9="/whirlwind/goes16/swir/fulldisk_full/"+ctime_file_string+"_fulldisk_full.jpg"
filename16="/whirlwind/goes16/swir/amazon/"+ctime_file_string+"_amazon.jpg"

#fig.figimage(aoslogo,  0, fig.bbox.ymax - aoslogoheight - 28  , zorder=10)
#fig2.figimage(aoslogo,  0, fig2.bbox.ymax - aoslogoheight + 156  , zorder=10)
#fig9.figimage(aoslogo,  0, fig9.bbox.ymax - aoslogoheight - 300  , zorder=10)
fig16.figimage(aoslogo,  0, fig16.bbox.ymax - aoslogoheight - 28  , zorder=10)
...
import glob
# NAMER
file_list = glob.glob('/whirlwind/goes16/swir/amazon/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 images
thefile = open('/whirlwind/goes16/swir/amazon_24_temp.list', 'w')
...
thefile.close
os.rename('/whirlwind/goes16/swir/amazon_24_temp.list','/whirlwind/goes16/swir/goes16_amazon_loop.list')

# 12h // 60 images
thefile = open('/whirlwind/goes16/swir/amazon_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/swir/amazon_60_temp.list','/whirlwind/goes16/swir/goes16_amazon_loop_60.list')

shutil.copy(filename16, "/whirlwind/goes16/swir/amazon/latest_amazon_1.jpg")
    
quit()

# NAMER
file_list = glob.glob('/whirlwind/goes16/irc13m/namer/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 images
thefile = open('/whirlwind/goes16/irc13m/namer_24_temp.list', 'w')
thelist = file_list[-24:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/irc13m/namer_24_temp.list','/whirlwind/goes16/irc13m/goes16_namer_loop.list')

# 12h // 60 images
thefile = open('/whirlwind/goes16/irc13m/namer_60_temp.list', 'w')
thelist = file_list[-60:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/irc13m/namer_60_temp.list','/whirlwind/goes16/irc13m/goes16_namer_loop_60.list')
...
# FULLDISK
file_list = glob.glob('/whirlwind/goes16/irc13m/fulldisk/2*.jpg')
file_list.sort()
#print("file list is ",file_list)

# 6h // 24 images
thefile = open('/whirlwind/goes16/irc13m/fulldisk_24_temp.list', 'w')
thelist = file_list[-24:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/irc13m/fulldisk_24_temp.list','/whirlwind/goes16/irc13m/goes16_fulldisk_loop.list')

# 12h // 60 images
thefile = open('/whirlwind/goes16/irc13m/fulldisk_60_temp.list', 'w')
thelist = file_list[-60:]
#print ("thelist is ",thelist)
...
for item in thelist:
    ...
    thefile.write(mid + '/' + tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/irc13m/fulldisk_60_temp.list','/whirlwind/goes16/irc13m/goes16_fulldisk_loop_60.list')
